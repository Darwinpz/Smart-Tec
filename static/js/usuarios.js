...
$(document).ready(function () {
    var table = $('#table_usuarios').DataTable({
        ...
        "columnDefs": [
            ...
            },
            {
                "targets": -1,
                "data": null,
                "defaultContent": '<a type="button" class="btn btn-primary btn-editar-usuarios" ><i class="fas fa-edit"></i></a> <a type="button" class="btn btn-danger btn-eliminar-usuarios"><i class="fas fa-trash"></i></a>',
            }
        ],
    ...
    $('#table_usuarios tbody').on('click', '.btn-editar-usuarios', function () {
        ...
        form.setAttribute("action", "/principal/edit_usuario")
...
$('#usuarioModal').on('show.bs.modal', function (event) {
    ...
    form.setAttribute("action", "/principal/save_usuarios")
